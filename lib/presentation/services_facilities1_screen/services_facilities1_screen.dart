...
class ServicesFacilities1Screen
    extends GetWidget<ServicesFacilities1Controller> {
  @override
                                                              ...
                                                              Container(
                                                                  ...
                                                                  child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                            child:
                                                                                Padding(padding: EdgeInsets.only(left: getHorizontalSize(4), top: getVerticalSize(2), right: getHorizontalSize(4), bottom: getVerticalSize(2)), child: Text(controller.servicesFacilities1ModelObj.value.txtReceptionOpen.value, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textStyleProximaNovasemibold16.copyWith(fontSize: getFontSize(16)))))
                                                                      ])),
                                                              Padding(
                                                                  padding: EdgeInsets.only(
                                                                      top: getVerticalSize(
                                                              ...
                                                              Container(
                                                                  ...
                                                                  child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                            child:
                                                                                Padding(padding: EdgeInsets.only(left: getHorizontalSize(4), top: getVerticalSize(2), right: getHorizontalSize(4), bottom: getVerticalSize(2)), child: Text(controller.servicesFacilities1ModelObj.value.txtCreditCards.value, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textStyleProximaNovasemibold16_1.copyWith(fontSize: getFontSize(16)))))
                                                                      ])),
                                                              Padding(
                                                                  padding: EdgeInsets.only(
                                                                      top: getVerticalSize(
