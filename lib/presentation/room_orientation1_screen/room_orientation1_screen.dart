...
class RoomOrientation1Screen extends GetWidget<RoomOrientation1Controller> {
  @override
                                                                      ...
                                                                      child: Padding(
                                                                          padding: EdgeInsets.only(
                                                                              ...
                                                                              bottom: getVerticalSize(
                                                                                  10)),
                                                                          child: Text(
                                                                              controller.roomOrientation1ModelObj.value.txtKeyTag.value,
                                                                      ...
                                                                      child: Padding(
                                                                          padding: EdgeInsets.only(
                                                                              ...
                                                                              bottom: getVerticalSize(
                                                                                  10)),
                                                                          child: Text(
                                                                              controller.roomOrientation1ModelObj.value.txtReverseOsmosis.value,
                                                                              overflow: TextOverflow.ellipsis,
                                                                              textAlign: TextAlign.center,
                                                                              style: AppStyle.textStyleProximaNovasemibold16.copyWith(fontSize: getFontSize(16)))))
                                                                ])),
                                                                      ...
                                                                      child: Padding(
                                                                          padding: EdgeInsets.only(
                                                                              ...
                                                                              bottom: getVerticalSize(
                                                                                  10)),
                                                                          child: Text(
                                                                              controller.roomOrientation1ModelObj.value.txtBathrobe.value,
                                                                              overflow: TextOverflow.ellipsis,
                                                                              textAlign: TextAlign.center,
                                                                              style: AppStyle.textStyleProximaNovasemibold16.copyWith(fontSize: getFontSize(16)))))
                                                                ])),
