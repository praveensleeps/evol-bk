import '../activities2_screen/widgets/activities2_item_widget.dart';
import 'controller/activities2_controller.dart';
import 'controller/activities2_item_controller.dart';
import 'models/activities2_item_model.dart';
import 'package:evolve_back/core/app_export.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Activities2Screen extends GetWidget<Activities2Controller> {
  @override
                        ...
                        children: [
                          Expanded(
                            child: Padding(
                              ...
                              child: Text(
                                controller.activities2ModelObj.value
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: controller.activities2ModelObj.value
                              .activities2ItemList.length,
                          itemBuilder: (context, index) {
                            Rx<Activities2ItemModel> model = controller
                                .activities2ModelObj
                                .value
                                .activities2ItemList[index]
                                .obs;
                            return Activities2ItemWidget(
                                Activities2ItemController(model));
                          },
                        ),
                      ),
                      Container(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              controller
                                  .activities2ModelObj.value.txtHome.value,
                              textAlign: TextAlign.left,
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              controller.activities2ModelObj.value.txtActivities
                                  .value,
                              textAlign: TextAlign.left,
