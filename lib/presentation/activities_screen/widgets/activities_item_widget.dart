...
class ActivitiesItemWidget extends StatelessWidget {
  ActivitiesItemWidget(this.controller);

  ActivitiesItemController controller;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            controller.activitiesItemModelObj.value.txtPlantationWalk.value,
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Text(
                                        controller.activitiesItemModelObj.value
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        controller
                            .activitiesItemModelObj.value.txtTiming4PmT.value,
                        textAlign: TextAlign.left,
                        style:
